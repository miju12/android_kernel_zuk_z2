...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing \
		   ...
		   -Wno-memset-transposed-args -Wno-unused-const-variable -Wno-discarded-array-qualifiers -Wno-switch -Wno-format -Wno-misleading-indentation -Wno-tautological-compare \
